Shader "CustomShader/UI/Default" {
	Properties {
		...
		[Toggle(ENABLE_GREY_SCALE)] _EnableGreyScale ("Enable Grey Scale", Float) = 0
	...
	SubShader {
		...
		Pass {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					Keywords { "ENABLE_GREY_SCALE" "UNITY_UI_ALPHACLIP" }
					"vs_4_0
				...
				SubProgram "d3d11 " {
					Keywords { "ENABLE_GREY_SCALE" "UNITY_UI_CLIP_RECT" }
					"vs_4_0
				...
				SubProgram "d3d11 " {
					Keywords { "ENABLE_GREY_SCALE" "UNITY_UI_ALPHACLIP" "UNITY_UI_CLIP_RECT" }
					"vs_4_0
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 + _TextureSampleAdd;
					    u_xlat0 = u_xlat0.xwyz * vs_COLOR0.xwyz;
				...
				SubProgram "d3d11 " {
					...
					;
					    ...
					    u_xlat1 = u_xlat1 + _TextureSampleAdd;
					    u_xlat1 = u_xlat1 * vs_COLOR0;
					    u_xlat0.y = u_xlat0.x * u_xlat1.w;
					    u_xlat0.x = dot(u_xlat1.xyz, vec3(0.298999995, 0.587000012, 0.114));
					    SV_Target0 = u_xlat0.xxxy;
					    return;
					}"
				}
