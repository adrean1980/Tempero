	...
	SubShader {
		...
		0 {
			...
			SubProgram "gles hw_tier00 " {
					Keywords { "DIRECTIONAL" "_SHAPE_FORWARD" }
					"!!GLES
					//ShaderGLESExporter
					#version 100
					...
					void main ()
					{
					  ...
					  tmpvar_12 = ((_EmmissionRange + 2.0) - ((worldPos_2.z - _PlayerLocation.z) / 4.0));
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat16_3 = _EmmissionRange + 2.0;
					    u_xlat0.x = (-u_xlat0.x) * 0.25 + u_xlat16_3;
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "DIRECTIONAL" "LIGHTPROBE_SH" "ENABLE_FRESNEL" "_SHAPE_FORWARD" }
					"!!GLES
					//ShaderGLESExporter
					#version 100
					...
					void main ()
					{
					  ...
					  tmpvar_14 = ((_EmmissionRange + 2.0) - ((worldPos_2.z - _PlayerLocation.z) / 4.0));
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat1.zzzz + u_xlat2;
					    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat1.wwww + u_xlat2;
					    u_xlat12 = u_xlat0.z + (-_PlayerLocation.z);
					    vs_TEXCOORD4.xyz = u_xlat0.xyz;
					    u_xlat16_3 = _EmmissionRange + 2.0;
					    u_xlat0.x = (-u_xlat12) * 0.25 + u_xlat16_3;
					    u_xlat16_3 = max(u_xlat0.x, 0.200000003);
					    vs_TEXCOORD0.z = u_xlat16_3;
					#ifdef UNITY_ADRENO_ES3
					    { bool cond = 0.0<_EmmissionMultiplier; u_xlati0 = int(!!cond ? 0xFFFFFFFFu : uint(0u)); }
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "DIRECTIONAL" "LIGHTPROBE_SH" "_VERTEXCOLOR_ON" "_SHAPE_FORWARD" }
					"!!GLES
					//ShaderGLESExporter
					#version 100
					...
					void main ()
					{
					  ...
					  tmpvar_3.xy = ((_glesMultiTexCoord0.xy * _MainTex_ST.xy) + _MainTex_ST.zw);
					  lowp vec3 tmpvar_12;
					  tmpvar_12 = (_glesColor.xyz - vec3(0.5, 0.5, 0.5));
					  mediump vec3 tmpvar_13;
					  tmpvar_13 = (worldPos_2 - tmpvar_12);
					  highp float tmpvar_14;
					  tmpvar_14 = ((_EmmissionRange + 2.0) - ((tmpvar_13.z - _PlayerLocation.z) / 4.0));
					  _EmmissionScale_1 = tmpvar_14;
					  mediump float tmpvar_15;
					  tmpvar_15 = max (0.2, _EmmissionScale_1);
					  tmpvar_3.z = tmpvar_15;
				...
				SubProgram "gles3 hw_tier00 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = hlslcc_mtx4x4unity_MatrixVP[2] * u_xlat1.zzzz + u_xlat2;
					    gl_Position = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat1.wwww + u_xlat2;
					    u_xlat16_3 = in_COLOR0.z + -0.5;
					    u_xlat16_3 = u_xlat0.x + (-u_xlat16_3);
					    u_xlat0.x = u_xlat16_3 + (-_PlayerLocation.z);
					    u_xlat16_3 = _EmmissionRange + 2.0;
					    u_xlat0.x = (-u_xlat0.x) * 0.25 + u_xlat16_3;
					    u_xlat16_3 = max(u_xlat0.x, 0.200000003);
					    vs_TEXCOORD0.z = u_xlat16_3;
